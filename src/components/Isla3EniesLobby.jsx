...
export default function Isla3EniesLobby({ onBackToMenu, onIslandCompleted, playClick }) {
  return (
    <motion.section
    ...
    >
      <p className="text-xs font-bold uppercase tracking-[0.2em] text-amber-900">Isla 3: Enies Lobby</p>
